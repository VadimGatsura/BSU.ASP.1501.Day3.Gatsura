    ...
    public class Polynomial {
        ...
        public Polynomial(int[] coefficientArray) {
            ...
            if (coefficientArray.Length == 0)
                throw new ArgumentException($"Empty array: {nameof(coefficientArray)}");
            ...
            Degree = m_CoefficientArray.Length;
        }
        public Polynomial(Polynomial obj) {
            if(obj == null)
                throw new ArgumentNullException(nameof(obj));
            m_CoefficientArray = new int[obj.Degree];
        ...
        public override bool Equals(object obj) {
            ...
            return EqualsCoefficientArrays(this.m_CoefficientArray, ((Polynomial)obj).m_CoefficientArray);
        }
        ...
        public bool Equals(Polynomial obj) {
            ...
            return EqualsCoefficientArrays(this.m_CoefficientArray, obj.m_CoefficientArray);
        }

        public override int GetHashCode() {
            unchecked {
                int hash = 17;
                foreach (var item in m_CoefficientArray)
        ...
        public static Polynomial Add(Polynomial a, Polynomial b) {
            ...
            int[] tempArray = new int[newDegree];
        ...
        private string GetStringRepresentation() {
            ...
            for(int i = m_CoefficientArray.Length - 1; i >= 0; i--) {
                ...
                if (i != m_CoefficientArray.Length - 1)
                    @return.Append(" + ");
                @return.Append(m_CoefficientArray[i]);
                if(i != 0) 
                    @return.Append($"*X^({i})");
            }
